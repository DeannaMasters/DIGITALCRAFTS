const data = [
  ...
  for (let index = 0; index < data[0].pokemon.length; index++) {
    const singlePokemon = data[0].pokemon[index];
    ...
    const cardImg = document.createElement("img");
    cardName.innerText = singlePokemon.name;
    cardImg.src = singlePokemon.sprites.front;
